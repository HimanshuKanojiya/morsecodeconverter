"""
Morse Code Converter V 1.1
Description:
This program is to convert and decode the plain text/morse code.

Author of this Script: Himanshu Kanojiya
...
def main_launcher():
    ...
    try:
        your_choice = int(raw_input("Enter Your Choice > "))

        if your_choice == 1:

            try:
                your_text = str(raw_input("Enter Your Text to Convert > "))
            ...
            try:
                your_text = str(raw_input("Enter Your Morse Code to Convert > "))
                access = morsecoders(your_text)
...
if __name__ == '__main__':
    ...
    continue_option = str(raw_input("Type (Y) fcr Continue > "))
